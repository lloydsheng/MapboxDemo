//
//  AnnoitatedLineViewController.swift
//  MapboxDemo
//
...
class AnnoitatedLineViewController: MBDBaseViewController, MGLMapViewDelegate {
    ...
    func loadGeoJson() {
        DispatchQueue.global().async {
            ...
            guard let jsonUrl = Bundle.main.url(forResource: "line", withExtension: "geojson") else { return }
